        ...
        "CandidatoPage.useEffect": ()=>{
            const fetchData = {
                "CandidatoPage.useEffect.fetchData": async ()=>{
                    const { data: candidatoData, error: candidatoError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('candidatos').select('*').eq('id', id).single();
...
_s(CandidatoPage, "0h2rqA+icYlw+YFhZy9hw3ZwX10=", false, function() {
    return [
