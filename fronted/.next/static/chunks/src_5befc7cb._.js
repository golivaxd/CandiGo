...
"[project]/src/app/noticiascopy/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function NoticiasPage() {
        ...
        "NoticiasPage.useEffect": ()=>{
            fetch('/api/news').then({
                ...
                "NoticiasPage.useEffect": (data)=>{
                    // Normalizamos los títulos para que siempre sean string
                    const normalized = data.articles.map({
                        "NoticiasPage.useEffect.normalized": (article)=>({
                                ...article,
                                title: typeof article.title === 'string' ? article.title : article.title.name
                            })
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/src/app/noticiascopy/page.tsx",
        lineNumber: 43,
        columnNumber: 23
    }, this);
...
//# sourceMappingURL=src_5befc7cb._.js.map